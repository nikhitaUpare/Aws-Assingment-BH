...
private_subnet2 = ec2.create_subnet(CidrBlock='10.0.11.0/24', VpcId=vpc_id, AvailabilityZone='us-east-1b')
...
vgw = ec2.create_vpn_gateway(AvailabilityZone='us-east-1a',Type='ipsec.1')
vgw_id = vgw['VpnGateway']['VpnGatewayId']

# Attach Virtual Private Gateway to VPC
ec2.attach_vpn_gateway(VpcId=vpc_id, VpnGatewayId=vgw_id)
...
private_hosted_zone = route53.create_hosted_zone(
    Name='cloud.com',
    VPC={'VPCId': vpc_id, 'SubnetIds': [private_subnet_id1, private_subnet_id2]}
)
...
resolver_rule_inbound = route53resolver.create_resolver_rule(
    CreatorRequestId='string',
    DomainName='cloud.com',
    Name='Route53ResolverInboundEndpoint',
    RuleAction='FORWARD',
    RuleActionAssociation={'Name': 'Route53ResolverInboundEndpointAssociation'},
    RuleActionForwardConfig={'DestinationAddresses': ['192.168.0.0/16']}
)
...
resolver_rule_outbound = route53resolver.create_resolver_rule(
    CreatorRequestId='String',
    DomainName='onprem.com',
    Name='Route53ResolverOutboundEndpoint',
    RuleAction='FORWARD',
    RuleActionAssociation={'Name': 'Route53ResolverOutboundEndpointAssociation'},
    RuleActionForwardConfig={'DestinationAddresses': ['192.168.0.0/16']}
)
