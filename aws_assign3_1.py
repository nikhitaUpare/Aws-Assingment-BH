...
# Target registration to target group

target_group_arn = target_group1['TargetGroupArn']
...
lambda_target = elbv2_client.register_targets(
    TargetGroupArn=target_group2['TargetGroupArn'],
    Targets=[
        {
            'Id': 'your-lambda-function-arn',  # Replace with your Lambda function ARN
            'Port': 80,
        },
    ]
)
